...
public class TicTacToeClient extends Application
    ...
    private ObjectInputStream msgFromServer;
        ...
        new Thread(() -> {
            try {
                ...
                if (player == PLAYER1) {
                    ...
                    // fromServer.readInt();
                    System.out.println("Made it before read.");
                    msgFromServer.readObject();
    ...
    private void sendMove() throws IOException {
        ...
        msgToServer.writeObject(new MoveMessage(rowSelected,columnSelected,"Move sent: Client -> Controller."));
